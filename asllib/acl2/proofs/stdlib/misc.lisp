...
(defthm zeros-correct
  (implies (and (subprograms-match '("Zeros" "Zeros-1") 
                ...
                (natp n)
                (posp clk)
                (< (stack_size-lookup "Zeros-1" (global-env->stack_size (env->global env)))
                   (expt 2 40)))
...
(defthm ones-correct
  (implies (and (subprograms-match '("Ones" "Ones-1" "Zeros-1") 
                ...
                (natp n)
                (< 1 (nfix clk))
                (< (stack_size-lookup "Ones-1" (global-env->stack_size (env->global env)))
                   (expt 2 40))
                (< (stack_size-lookup "Zeros-1" (global-env->stack_size (env->global env)))
                   (expt 2 40)))
...
(defthm replicatebit-correct
  (implies (and (subprograms-match '("ReplicateBit" "ReplicateBit-1" "Ones-1" "Zeros-1") 
                ...
                (natp n)
                (< 2 (nfix clk))
                (< (stack_size-lookup "ReplicateBit-1" (global-env->stack_size (env->global env)))
                   (expt 2 40))
                (< (stack_size-lookup "Ones-1" (global-env->stack_size (env->global env)))
                   (expt 2 40))
                (< (stack_size-lookup "Zeros-1" (global-env->stack_size (env->global env)))
...
(defthm zeroextend-correct
  (implies (and (subprograms-match '("ZeroExtend" "ZeroExtend-1" "Zeros-1")
                ...
                (< (stack_size-lookup "Zeros-1" (global-env->stack_size (env->global env)))
                   (expt 2 40))
                (< (stack_size-lookup "ZeroExtend-1" (global-env->stack_size (env->global env)))
                   (expt 2 40)))
