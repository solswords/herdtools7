...
(cmr::defevaluator-fixed tac-ev tac-ev-lst
  ((emptyset)
   ...
   (setintersect s1 s2)
   (setimage s r)
   (setimage-witness w s r)
   (setpreimage r s)
   (setpreimage-witness w r s)
   (relidentity s)
   (relunion r1 r2)
   (relintersect r1 r2)
   (relcompose r1 r2)
   (relcompose-midpoint v w r1 r2)
   (relstar r)
   (relstar-bounded n r)
   (relplus r)
   (relinverse r)
...
(defconst *tac-function-argument-types*
  '((emptyset)
    ...
    (setimage :set :rel)
    (setimage-witness :event :set :rel)
    (setpreimage :rel :set)
    (setpreimage-witness :event :rel :set)
    (relidentity :set)
    (relunion :rel :rel)
    (relintersect :rel :rel)
    (relcompose :rel :rel)
    (relcompose-midpoint :event :event :rel :rel)
    (relstar :rel)
    ...
    (pred-set-intersects :set :set)
    (pred-rel-intersects :rel :rel)
...
(defconst *tac-function-return-types*
  '((emptyset . :set)
    ...
    (setintersect . :set)
    (setimage . :set)
    (setimage-witness . :event)
    (setpreimage . :set)
    (setpreimage-witness . :event)
    (relidentity . :rel)
    (relunion . :rel)
    (relintersect . :rel)
    (relcompose . :rel)
    (relcompose-midpoint . :event)
    (relstar . :rel)
    (relstar-bounded . :rel)
    (relplus . :rel)
    (relinverse . :rel)
    ...
    (pred-true . :pred)
    (pred-nonempty . :pred)
    (nonempty-witness . :event)
    (pred-set-intersects . :pred)
    (pred-rel-intersects . :pred)
    (pred-equal . :pred)
    (pred-in-set . :pred)
    (pred-in-rel . :pred)
    (base-rel-p . :pred)
